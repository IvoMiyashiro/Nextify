...
export const Footer = ({ alternative = false }) => {
   return (
      <footer className={`mt-16 ${alternative ? 'bg-white' : 'bg-custom'} rounded-t-3xl md:rounded-tr-custom text-gray-900`}>

         <div className="flex flex-col items-center pt-4 max-w-screen-lg md:w-4/5 mx-auto my-0">
            {
               !alternative
               &&
               <>
                  ...
                  <section className="mt-4">
                     <ul className="flex flex-wrap justify-center gap-10 gap-y-4 mx-auto my-0 max-w-screen-lg">
                        ...
                        <li className="font-body border-b-2 border-transparent pb-1 group">
            ...
            <section className="mt-4 p-1 border-t w-full text-center">
               <p className="text-sm">Design & Crafted by Ivan Miyashiro</p>
            </section>
         </div>
      </footer>
   );
